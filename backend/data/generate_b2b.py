...
def generate_synthetic_data(
    ...
    # Target 100 payments total. Real-life B2B distribution:
    #   exact=90%, partial=2%, multi=2%, garbled=2%,
    #   timing=2%, rounding=1%, orphan=1%
    total_payments = 100
    counts = {
        "exact":    90,
        "partial":  2,
    ...
    if output_dir is None:
        output_dir = Path(__file__).parent / "generated_b2b"
    ...
    # Summary
    print(f"=== ReconAgent Synthetic Data Generated (B2B Realistic) ===")
